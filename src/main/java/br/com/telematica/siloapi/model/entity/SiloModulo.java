...
public class SiloModulo {
  ...
  public SiloModulo(Long smocod, Silo silo, String smodes, Long smotse, String smonse, Long smotke, Long smotme,
      Integer smogmt, String smocke, String smocme, String smosta) {
    super();
    this.smocod = smocod;
    this.silo = silo;
    this.smodes = smodes;
