...
public class SiloModuloModel {
  ...
  public SiloModuloModel(Long silo, String descricao, Long totalSensor, String numSerie, Long timeoutKeepAlive,
      Long timeoutMedicao, Integer gmt, String corKeepAlive, String corMedicao, StatusDeviceEnum status) {
    this.silo = silo;
