...
public class MedicaoDeviceModel {
	...
	public MedicaoDeviceModel(Long applicationID, String applicationName, String devEUI, String deviceName, Integer timestamp, Long fCnt, Long fPort, String data, String data_encode, MedicaoDataModel object, Boolean adr, List<Object> rxInfo, Object txInfo) {
		super();
