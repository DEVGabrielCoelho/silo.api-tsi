...
import br.com.telematica.siloapi.model.dto.TokenValidationDeviceDTO;
import br.com.telematica.siloapi.records.AuthDeviceRecords;
...
public class AuthDeviceUtil {
	...
	public static boolean isValidDate(String dateString) throws IOException {
		try {
			...
			throw new IOException("Data não é compativel com o padrão esperado.");
		}
	}
